...
- legal_question: سؤال حقوقی واقعی که نیاز به جستجو در قوانین/مقررات دارد
  ...
  این شامل سؤال دربارهٔ تعریف/ماهیت/تفاوت اسناد حقوقی هم می‌شود
  («سند رسمی چیست؟»، «سند رسمی با سند عادی چه فرقی دارد؟»، «ثبت اسناد چه مزیتی دارد؟»)
  — این‌ها سؤال دربارهٔ یک مفهوم حقوقی‌اند، نه درخواست تنظیم سند.
- meta_capability: فقط دو حالت: (۱) سؤال دربارهٔ توانایی‌ها/هویت خودِ سیستم
  («چطور کار می‌کنی»، «وکیل هستی؟»، «چه کارهایی بلدی؟»)، یا
  (۲) درخواست صریح از سیستم برای نوشتن/تنظیم یک سند برای کاربر
  (مثلاً «برایم یک شکواییه بنویس»، «یک دادخواست تنظیم کن»، «قرارداد بنویس»).
  اگر کاربر دارد دربارهٔ یک سند یا مفهوم حقوقی سؤال می‌پرسد (نه درخواست نوشتنش)،
  این برچسب نیست — legal_question است.
