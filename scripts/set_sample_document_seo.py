...
OVERRIDES: dict[int, tuple[str, str, str, int, float]] = {
    626: (
        "نمونه اظهارنامه مطالبه وجه و خسارت تاخیر تادیه چک | وکیل تو",
    ...
    263: (
        "دادخواست الزام به تمکین (زوجه) | نمونه PDF رایگان | وکیل تو",
    ...
    364: (
        "نمونه سند خودرو مزایده‌ای (وکالت‌نامه خرید و تعویض پلاک) | وکیل تو",
    ...
    423: (
        "متن وکالت‌نامه تام‌الاختیار خرید و فروش | نمونه PDF | وکیل تو",
    ...
    672: (
        "اساسنامه شرکت تعاونی مسکن | نمونه PDF رایگان | وکیل تو",
    ...
    651: (
        "نمونه اساسنامه شرکت سهامی خاص (PDF رایگان) | وکیل تو",
    ...
    663: (
        "اساسنامه شرکت تعاونی (نمونه PDF رایگان) | وکیل تو",
    ...
    611: (
        "اظهارنامه تخلیه ملک به علت اتمام قرارداد اجاره | نمونه PDF | وکیل تو",
    ...
    21: (
        "نمونه قولنامه ماشین (خرید و فروش خودرو) | وکیل تو",
    ...
    654: (
        "مدارک لازم برای ثبت شرکت با مسئولیت محدود | وکیل تو",
    ...
    32: (
        "دانلود فرم قرارداد کار (نمونه رسمی وزارت کار) | وکیل تو",
